    ...
    return (
        <section id="contact" className="contact section">
            <div className="container">
                ...
                <div className="contact__team-section">
                    <p className="contact__team-text">Contact us through :</p>
                    <div className="contact__team-list">
                        <div className="contact__team-item">
                            <strong>Syed Khadeen:</strong> <a href="mailto:syed.khadeen@gmail.com">syed.khadeen@gmail.com</a> | <a href="tel:+923189177303">+92318 9177303</a>
                        </div>
                        <div className="contact__team-item">
                            <strong>Abdul Azeem:</strong> <a href="mailto:abdulazeemjd@gmail.com">abdulazeemjd@gmail.com</a> | <a href="tel:+923335141981">+92 333 5141981</a>
                        </div>
                        <div className="contact__team-item">
                            <strong>Iqramah Shah:</strong> <a href="mailto:iqramashah877@gmail.com">iqramashah877@gmail.com</a> | <a href="tel:+923155529798">+92 3155529798</a>
                        </div>
                    </div>
                </div>
