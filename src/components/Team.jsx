...
import { Github, Linkedin, User, X, Download, GraduationCap, Briefcase, Code, Mail, Phone } from 'lucide-react';
...
const teamMembers = [
    ...
    },
    {
        ...
        email: 'abdulazeemjd@gmail.com',
        phone: '+92 333 5141981',
        socials: {
            github: '#',
            linkedin: '#',
            profile: '#'
                            ...
                            <div className="team__card-inner">
                                ...
                                <div className="team__content">
                                    ...
                                    <div className="team__contact">
                                        <div className="team__contact-item">
                                            <Mail size={14} />
                                            <a href={`mailto:${member.email}`} className="team__contact-link">{member.email}</a>
                                        </div>
                                        <div className="team__contact-item">
                                            <Phone size={14} />
                                            <a href={`tel:${member.phone.replace(/\s/g, '')}`} className="team__contact-link">{member.phone}</a>
                                        </div>
                                    </div>
